...
const corsOptions = {
    origin: env_1.default.nodeEnv === 'production'
        ? [...(env_1.default.corsOrigin ? env_1.default.corsOrigin.split(',').map(o => o.trim()) : []), 'https://www.holidayindubai.com', 'https://holidayindubai.com', 'https://api.holidayindubai.com']
